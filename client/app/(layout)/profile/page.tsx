      ...
      <section className="min-h-screen bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white py-10">
        <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col items-center">
            ...
            <h1 className="text-3xl font-extrabold tracking-wider">martBul</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center hover:bg-gray-700 transition-colors duration-300">
              ...
              <p className="text-gray-400">Avg. Score: 10,485</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center hover:bg-gray-700 transition-colors duration-300">
              <h3 className="text-xl font-bold uppercase">Win Ratio - Duels</h3>
              <p className="text-4xl font-extrabold text-yellow-500">0.00%</p>
              <p className="text-gray-400">Played: 0</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center hover:bg-gray-700 transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-10">
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center hover:bg-gray-700 transition-colors duration-300">
              <h3 className="text-xl font-bold uppercase">Win Ratio - Team Duels</h3>
              <p className="text-4xl font-extrabold text-yellow-500">0.00%</p>
              <p className="text-gray-400">Played: 0</p>
            </div>
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg text-center hover:bg-gray-700 transition-colors duration-300">
